...
export function Footer() {
  return (
    <div className="text-center mt-8">
      ...
      {/* <!-- Instagram --> */}
      <Link href={'https://www.instagram.com/dgemendoza/'}>
      ...
      <Link href={'https://www.youtube.com/@PortalEducativoDGE'}>
      ...
      {/* <!-- TikTok --> */}
      <Link href={'https://www.tiktok.com/@dge_mendoza?_t=ZM-8uGVKI6l1fT&_r=1'}>
